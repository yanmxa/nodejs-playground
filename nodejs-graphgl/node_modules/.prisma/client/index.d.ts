  ...
  */
  ...
  export interface LinkDelegate {
    ...
    **/
     ...
     * @param {FindManyLinkArgs} args - Arguments to filter Links to count.
     * @example
     * // Count the number of Links
    ...
    **/
     ...
     * @param {AggregateLinkArgs} args - Select which aggregations you would like to apply and on what fields.
     * @example
  ...
  export interface VoteDelegate {
    ...
    **/
     ...
     * @param {FindManyVoteArgs} args - Arguments to filter Votes to count.
     * @example
     * // Count the number of Votes
    ...
    **/
     ...
     * @param {AggregateVoteArgs} args - Select which aggregations you would like to apply and on what fields.
     * @example
     * // Ordered by age ascending
     * // Where email contains prisma.io
     * // Limited to the 10 users
...
/**
 * @deprecated Renamed to `Prisma.VoteLinkIdUserIdCompoundUniqueInput`
 */
export type VoteLinkIdUserIdCompoundUniqueInput = Prisma.VoteLinkIdUserIdCompoundUniqueInput
